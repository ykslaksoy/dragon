...
export const dictionaries: Record<Locale, Dictionary> = {
  tr: {
    ...
    scenarioProfitCol: "NET KÂR",
    scenarioUnits: "ADET",
    platformsCell: "{n} platform",
    platformsCol: "PLATFORM",
    scenarioCol: "SENARYO",
    openPlatform: "Aç",
    linkCol: "LİNK",
    unitsCol: "ADET",
    platformCol: "PLATFORM",
    platformBreakdownTitle: "PLATFORM KIRILIMI",
    scenarioTitle: "SATIŞ PAYI",
    scenarioHint: "Kaç platformdan satacağına göre — pazarın tamamı değil.",
    scenarioMin: "Minimum",
    scenarioMid: "Gerçekçi",
    scenarioHigh: "En iyi",
    scenarioLine: "{units} adet/ay · net kâr {currency}{profit}",
    detailOpen: "Detay",
    detailClose: "Kapat",
    detailTitle: "SATIŞ VERİSİ",
    scoreDemandHelp:
  ...
  en: {
    ...
    scenarioProfitCol: "NET PROFIT",
    scenarioUnits: "UNITS",
    platformsCell: "{n} platforms",
    ...
    unitsCol: "UNITS",
    platformCol: "PLATFORM",
    platformBreakdownTitle: "PLATFORM BREAKDOWN",
    scenarioTitle: "SHARE SCENARIOS",
    scenarioHint: "By how many platforms you sell on — not the whole market.",
    scenarioMin: "Minimum",
    scenarioMid: "Realistic",
    scenarioHigh: "Best",
    scenarioLine: "{units} units/mo · net profit {currency}{profit}",
    detailOpen: "Details",
    detailClose: "Close",
    detailTitle: "SALES DATA",
    scoreDemandHelp:
  ...
  de: {
    ...
    scenarioProfitCol: "NETTOGEWINN",
    scenarioUnits: "STÜCK",
    platformsCell: "{n} Plattformen",
    platformsCol: "PLATTFORMEN",
    scenarioCol: "SZENARIO",
    openPlatform: "Öffnen",
    linkCol: "LINK",
    unitsCol: "STÜCK",
    platformCol: "PLATTFORM",
    platformBreakdownTitle: "PLATTFORM-AUFTEILUNG",
    scenarioTitle: "ANTEIL-SZENARIEN",
    scenarioHint: "Nach Anzahl der Plattformen — nicht der gesamte Markt.",
    scenarioMin: "Minimum",
    scenarioMid: "Realistisch",
    scenarioHigh: "Bestes",
    scenarioLine: "{units} Stk/Monat · Nettogewinn {currency}{profit}",
    detailOpen: "Details",
    detailClose: "Schließen",
    detailTitle: "VERKAUFSDATEN",
    scoreDemandHelp:
  ...
  fr: {
    ...
    scenarioProfitCol: "BÉNÉFICE NET",
    scenarioUnits: "UNITÉS",
    platformsCell: "{n} plateformes",
    platformsCol: "PLATEFORMES",
    ...
    scenarioTitle: "SCÉNARIOS DE PART",
    scenarioHint: "Selon le nombre de plateformes — pas tout le marché.",
    scenarioMin: "Minimum",
    scenarioMid: "Réaliste",
    scenarioHigh: "Meilleur",
    scenarioLine: "{units} u/mois · profit net {currency}{profit}",
    detailOpen: "Détails",
    detailClose: "Fermer",
    detailTitle: "DONNÉES DE VENTE",
    scoreDemandHelp:
  ...
  zh: {
    ...
    unitsCol: "件数",
    platformCol: "平台",
    platformBreakdownTitle: "平台明细",
    scenarioTitle: "份额情景",
    scenarioHint: "按上架平台数量估算 — 不是整个市场。",
    scenarioMin: "最低",
    scenarioMid: "现实",
    scenarioHigh: "最佳",
  ...
  ru: {
    ...
    scenarioProfitCol: "ЧИСТАЯ ПРИБЫЛЬ",
    scenarioUnits: "ШТ.",
    platformsCell: "{n} площадок",
    platformsCol: "ПЛОЩАДКИ",
    scenarioCol: "СЦЕНАРИЙ",
    openPlatform: "Открыть",
    linkCol: "ССЫЛКА",
    unitsCol: "ШТ.",
    platformCol: "ПЛОЩАДКА",
    platformBreakdownTitle: "РАЗБИВКА ПО ПЛОЩАДКАМ",
    scenarioTitle: "СЦЕНАРИИ ДОЛИ",
    scenarioHint: "По числу площадок — не весь рынок.",
    scenarioMin: "Минимум",
    scenarioMid: "Реалистично",
    scenarioHigh: "Лучший",
    scenarioLine: "{units} шт/мес · чистая прибыль {currency}{profit}",
    detailOpen: "Детали",
    detailClose: "Закрыть",
    detailTitle: "ДАННЫЕ ПРОДАЖ",
    scoreDemandHelp:
