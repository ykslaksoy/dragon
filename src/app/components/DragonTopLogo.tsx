...
/** Press-and-hold: close open header menus + suppress save/context sheet */
const HOLD_CLOSE_MS = 380;
...
function closeOpenMenus() {
  ...
  window.dispatchEvent(new Event("dragon:close-menus"));
}
 ...
 * - Studio-matched stage size (100×40 / 120×48) + vivid eye brightness
 * - Press-and-hold closes open header menus and blocks the image save sheet
 */
export function DragonTopLogo() {
  ...
  return (
    <div
      className="dragon-logo-stage relative h-[40px] w-[100px] shrink-0 overflow-hidden sm:h-[48px] sm:w-[120px]"
