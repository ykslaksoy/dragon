    ...
    <div className="m-0 min-h-dvh bg-[#070708] p-0 text-white selection:bg-[#8CFF4D]/30">
      ...
      <ProductResults
        ...
        copy={{
          ...
          netProfitLabel: t.netProfitLabel,
          totalProfitLabel: t.totalProfitLabel,
          totalRevenueLabel: t.totalRevenueLabel,
          targetSalesLabel: t.targetSalesLabel,
          scoreMonthlySalesHelp: t.scoreMonthlySalesHelp,
          scoreNetProfitHelp: t.scoreNetProfitHelp,
          scoreTotalProfitHelp: t.scoreTotalProfitHelp,
          scoreTotalRevenueHelp: t.scoreTotalRevenueHelp,
          scoreTargetSalesHelp: t.scoreTargetSalesHelp,
